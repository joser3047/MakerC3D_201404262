...
<YYINITIAL> {MAYOROIGUAL}	    { return new Symbol(sym.MAYOROIGUAL, yyline, yycolumn, null); }
<YYINITIAL> {MENOROIGUAL}	    { return new Symbol(sym.MENOROIGUAL, yyline, yycolumn, null); }
<YYINITIAL> {MAYORQUE}	    { return new Symbol(sym.MAYORQUE, yyline, yycolumn, null); }
<YYINITIAL> {MENOSQUE}	    { return new Symbol(sym.MENOSQUE, yyline, yycolumn, null); }
